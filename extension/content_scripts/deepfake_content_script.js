console.log("🧠 deepfkae content script loaded!");

// Global state
let activeAnalyses = new Map(); // Track active analyses for each video
const ANALYSIS_COOLDOWN = 5000;  // 1 second cooldown between analyses
...
async function analyzeVideo(video) {
    ...
    try {
        ...
        const response = await fetch('http://127.0.0.1:8000/deepfake/detect/', {
            method: 'POST',
            headers: {
